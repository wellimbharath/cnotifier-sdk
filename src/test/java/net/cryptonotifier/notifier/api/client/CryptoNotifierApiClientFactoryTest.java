...
public class CryptoNotifierApiClientFactoryTest extends TestCase {
  ...
  public void testSubscription() {
    ...
    NewSubscription
        newSubscription = new NewSubscription("TNaRAoLUyYEV2uF7GUrzSjRQTU8v5ZJ5VR","TRX","MAINNET","https://webhook.site/f65be83b-e316-4591-ab7c-73b92c99d05d",6);

    try {
      SubscriptionResponse exception = cryptoNotifierRestApiClient.createSubscription(newSubscription);
    } catch (CryptoNotifierError e) {
